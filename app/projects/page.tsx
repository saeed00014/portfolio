...
import bodySign from '../images/bodySign.png'
...
const ProjectPage = () => {
  ...
  return (
    <section className={styles.section}>
      ...
      <p className={styles.titleDis}>Take a look at some of my projects and perviews</p>
        ...
        {projects.map((project) => {
          ...
          return (
            <div key={project.id} className={styles.content}>
              <div className={styles.projectItself}>
              ...
              <div className={styles.projectPerview}>
                <div className={styles.perviewTitle}>
                ...
                <div className={styles.partOne}>
                  <Image 
                    ...
                    alt='asad'
                  />
                  <div className={styles.partOneDetails}>
                    <h1>Card</h1>
                    <p>as i said this project has a shop and whatever you buy gets saved here first.
                      this section uses reduxToolkit for state managment and localStorage to save the card 
                      localy on your browser you can also delete and change quantity of items.
                    </p>
                  </div>
                </div>
                <div className={styles.partOne2}>
                  <div className={styles.partOneDetails}>
                    <h1>Card</h1>
                    <p>as i said this project has a shop and whatever you buy gets saved here first.
                      this section uses reduxToolkit for state managment and localStorage to save the card 
